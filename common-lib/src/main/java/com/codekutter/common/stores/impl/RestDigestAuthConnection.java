...
public class RestDigestAuthConnection extends RestConnection {
    ...
    public Invocation.Builder target(@Nonnull String url) throws ConnectionException {
        ...
        return client.target(url).request()
                .property(HttpAuthenticationFeature.HTTP_AUTHENTICATION_DIGEST_USERNAME, username)
                .property(HttpAuthenticationFeature.HTTP_AUTHENTICATION_DIGEST_PASSWORD, password.getDecryptedValue());
    }
}
