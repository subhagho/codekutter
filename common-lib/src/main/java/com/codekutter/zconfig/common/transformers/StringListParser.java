...
public class StringListParser implements ICustomParser<List<String>> {
    /**
     ...
     */
    @Override
    public List<String> parse(@Nonnull AbstractConfigNode node, @Nonnull String name) throws ConfigurationException {
        node = node.find(name);
        ...
        if (node instanceof ConfigPathNode) {
            ...
            if (cnode instanceof ConfigValueNode) {
                ...
                values.add(((ConfigValueNode) cnode).getValue());
            }
