...
import com.codekutter.common.model.Version;
...
public class Configuration {
    ...
    /**
     * Configuration settings to be used for this instance.
     */
    private ConfigurationSettings settings;

    /**
     * Config Password Vault, is password encoded.
     */
    private ConfigVault configVault = null;
    ...
    /**
     * Set the config Vault to use for storing encrypted data.
     *
     * @param configVault - Config Vault instance.
     * @return - Self
     */
    public Configuration withConfigVault(@Nonnull ConfigVault configVault) {
        this.configVault = configVault;

        return this;
    }

    /**
     * Get the config Vault to use for storing encrypted data.
     *
     * @return - Config Vault instance.
     */
    public ConfigVault getConfigVault() {
        return configVault;
    }
