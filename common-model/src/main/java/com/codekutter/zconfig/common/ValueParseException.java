...
/**
 * Exception instance used to raise error when parsing for a specific value type failed.
 */
public class ValueParseException extends Exception {
    private static final String PREFIX = "Exception Parsing Value : %s";
     ...
     */
    public ValueParseException(String s) {
     ...
     */
    public ValueParseException(String s, Throwable throwable) {
     ...
     * @param throwable - Inner cause.
     */
    public ValueParseException(Throwable throwable) {
