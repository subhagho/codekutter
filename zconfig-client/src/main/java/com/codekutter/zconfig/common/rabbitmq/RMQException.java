 ...
 */
public class RMQException extends Exception {
    private static final String PREFIX = "RabbitMQ Client Exception : %s";
     ...
     */
    public RMQException(String s, Throwable throwable) {
     ...
     * @param throwable - Inner cause.
     */
    public RMQException(Throwable throwable) {
