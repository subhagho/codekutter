...
class MSGraphConnectionTest {
    ...
    private static final String CONNECTION_NAME = "TestOneDriveConnection";
    ...
    static void setup() throws Exception {
        try {
            ...
            LogUtils.error(MSGraphConnectionTest.class, t);
            throw t;
        }
    }
    ...
    void connection() {
        try {
            MSGraphConnection connection = (MSGraphConnection) ConnectionManager.get().connection(CONNECTION_NAME, IGraphServiceClient.class);
